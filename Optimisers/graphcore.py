...
def main():
    ...
    opt = LearningRateAndMomentumDecay(function, varSymbols, varInits, tol=1e-5, learning_rate=0.02, learning_rate_scalar=0.95, momentum_rate=0.5, variable_momentum_scalar=0.1, delay=2)
